...
final class BootstrapService
{
    ...
    public function __construct(bool $debug = false)
    {
        ...
        $this->configPath = dirname($this->humhubPath) . '/config';
        $this->vendorPath = dirname($this->humhubPath) . '/vendor';
    }

    public function setPaths(?string $config = null, ?string $vendor = null, ?string $humhub = null): void
    {
        $this->humhubPath = rtrim($humhub ?: $this->humhubPath, '/\\');
        $this->configPath = $config ?: dirname($this->humhubPath) . '/config';
        $this->vendorPath = $vendor ?: dirname($this->humhubPath) . '/vendor';
    }
